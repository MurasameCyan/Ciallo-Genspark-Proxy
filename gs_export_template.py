"""Genspark cookie 提取模板，可由本地脚本或容器注册服务直接调用。"""
import os, time, json
import cloakbrowser

PROFILE = os.environ.get("GS_PROFILE", r"{{PROFILE}}")
ACCOUNT = os.environ.get("GS_ACCOUNT", "{{ACCOUNT}}")
EMAIL = os.environ.get("GS_EMAIL", "{{EMAIL}}")
COOKIE_FILE = os.environ.get("GS_COOKIE_FILE", r"{{COOKIE_FILE}}")
